...
def parse_nmap_report(nmap_stdout, taskid=None):
	try:
		...
		my_services_backend = BackendPluginFactory.create(plugin_name='backend_service', url=global_dbcoon, echo=False, encoding='utf-8')
		my_hosts_backend = BackendPluginFactory.create(plugin_name='backend_host', url=global_dbcoon, echo=False, encoding='utf-8')
		# 开始处理扫描结果
